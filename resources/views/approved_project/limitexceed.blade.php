...
<div class="page-wrap">
    <div class="inner-page">
        <div class="page-header">
            <h1>Project Threshold Limit 2</h1>
        </div>
        ...
        <div class="page-text">
            <table>
                <tr>
                    <th colspan="2">
                        <p>Exceed Threshold Limit 2</p>
                    </th>
                </tr>
                <tr>
                    <td>Project Name</td>
                    <td>{{$view_array['project_name']}}</td>
                </tr>
                <tr>
                    <td>Thresold Limit 2</td>
                    <td>{{$view_array['threshold_limit2']}}</td>
                </tr>
                <tr>
                    <td>Total Hours Till Date</td>
                    <td>{{$view_array['total_hours']}}</td>
                </tr>
            </table>
        </div>
