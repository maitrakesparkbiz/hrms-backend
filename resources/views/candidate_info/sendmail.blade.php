...
<head>
    <title>{{ucwords($view_array['title'])}}</title>
    <meta charset="UTF-8">
...
<div class="page-wrap">
    <div class="inner-page">
        <div class="page-header">
            <h1>{{ucwords($view_array['title'])}}</h1>
        </div>
        ...
        <div class="page-text">
            <h2><span>Dear </span> {{$view_array['candidate_name']}} </h2>
        </div>

        <div class="page-time">
            <h2>
            {!! $view_array['description']!!}
            </h2>
        </div>

        <div class="page-address">
            <h3>eSparkBiz Technologies Pvt. Ltd.</h3>
            <p>Address: 101/102, Shanti Mall, Sattadhar X Roads, Sola Road, Ghatlodia, Ahmedabad, Gujarat 380061</p>
            <h6>
