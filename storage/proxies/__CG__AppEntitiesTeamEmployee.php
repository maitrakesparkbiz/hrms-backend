 ...
 */
class TeamEmployee extends \App\Entities\TeamEmployee implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'team_id', 'member'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TeamEmployee $proxy) {
    ...
    public function setTeamId($team_id): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTeamId', [$team_id]);

        parent::setTeamId($team_id);
    }
